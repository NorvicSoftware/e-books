...
class AuthorSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $author1->user_id = 3;//User::all()->random()->id;
        $author1->save();
        ...
        $author2->user_id = 4;//User::all()->random()->id;
        $author2->save();
        ...
        $author3->user_id = 5;//User::all()->random()->id;
        $author3->save();
        ...
        $author4->user_id = 6;//User::all()->random()->id;
        $author4->save();
        ...
        $author5->user_id = 7;//User::all()->random()->id;
        $author5->save();
    }
}
